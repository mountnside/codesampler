...
#if !defined(GL_ARB_draw_buffers) || !defined(GL_GLEXT_PROTOTYPES)
...
#if !defined(GL_ARB_multisample) || !defined(GL_GLEXT_PROTOTYPES)
...
#if !defined(GL_ARB_point_parameters) || !defined(GL_GLEXT_PROTOTYPES)
...
#if !defined(GL_ARB_transpose_matrix) || !defined(GL_GLEXT_PROTOTYPES)
...
#if !defined(GL_ARB_window_pos) || !defined(GL_GLEXT_PROTOTYPES)
#define GL_ARB_window_pos_PROTOTYPES
#endif

#if !defined(GL_ATI_fragment_shader) || !defined(GL_GLEXT_PROTOTYPES)
#define GL_ATI_fragment_shader_PROTOTYPES
#endif

#if !defined(GL_ATI_separate_stencil) || !defined(GL_GLEXT_PROTOTYPES)
#define GL_ATI_separate_stencil_PROTOTYPES
#endif

#if !defined(GL_EXT_blend_color) || !defined(GL_GLEXT_PROTOTYPES)
#define GL_EXT_blend_color_PROTOTYPES
#endif

#if !defined(GL_EXT_blend_func_separate) || !defined(GL_GLEXT_PROTOTYPES)
#define GL_EXT_blend_func_separate_PROTOTYPES
#endif

#if !defined(GL_EXT_blend_minmax) || !defined(GL_GLEXT_PROTOTYPES)
#define GL_EXT_blend_minmax_PROTOTYPES
#endif

#if !defined(GL_EXT_draw_range_elements) || !defined(GL_GLEXT_PROTOTYPES)
#define GL_EXT_draw_range_elements_PROTOTYPES
#endif

#if !defined(GL_EXT_fog_coord) || !defined(GL_GLEXT_PROTOTYPES)
#define GL_EXT_fog_coord_PROTOTYPES
#endif

#if !defined(GL_EXT_framebuffer_object) || !defined(GL_GLEXT_PROTOTYPES)
...
#if !defined(GL_EXT_secondary_color) || !defined(GL_GLEXT_PROTOTYPES)
#define GL_EXT_secondary_color_PROTOTYPES
#endif

#if !defined(GL_EXT_texture3D) || !defined(GL_GLEXT_PROTOTYPES)
