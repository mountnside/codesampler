...
// GLOBALS
//-----------------------------------------------------------------------------
miniDumper* miniDumper::s_pMiniDumper = NULL;
LPCRITICAL_SECTION miniDumper::s_pCriticalSection = NULL;
...
{
	// Our miniDumper should act alone as a singleton.
...
//-----------------------------------------------------------------------------
LONG miniDumper::unhandledExceptionHandler( _EXCEPTION_POINTERS *pExceptionInfo )
{
	if( !s_pMiniDumper )
