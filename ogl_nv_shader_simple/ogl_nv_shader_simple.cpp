					...
					int       nCmdShow )
{
	...
	g_hWnd = CreateWindowEx( NULL,"MY_WINDOWS_CLASS",
						    "OpenGL - Simple Vertex Shader Using NV_vertex_program",
                            WS_OVERLAPPEDWINDOW,
...
void initShader( void )
{
	...
	{
		MessageBox(NULL,"GL_NV_vertex_program extension was not found",
	...
	else
	{
		...
		{
			MessageBox(NULL,"One or more GL_NV_vertex_program functions were not found",
				"ERROR",MB_OK|MB_ICONEXCLAMATION);
			return;
		}
	}
    ...
    unsigned char *shader_assembly = readShaderFile( "ogl_nv_shader_simple.nvv" );
...
void shutDown( void )
{
	glDeleteProgramsNV( 1, &g_vertexProgramID );
