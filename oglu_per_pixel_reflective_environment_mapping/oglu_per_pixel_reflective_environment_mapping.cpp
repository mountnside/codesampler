...
int WINAPI WinMain(	HINSTANCE hInstance,
	...
	g_hWnd = CreateWindowEx( NULL,"MY_WINDOWS_CLASS",
						    "OpenGL - Per-Pixel Reflective Environment Mapping Using Cg",
							WS_OVERLAPPEDWINDOW,
...
void init( void ) {
    ...
    cgVertexProgram = cgCreateProgramFromFile( cgContext,
											CG_SOURCE,
											"oglu_per_pixel_reflective_environment_mapping_vs.cg",
											cgVertexProfile,
											NULL,
											NULL );
    ...
    if ( !cgModelViewProj || !cgModelView || !cgModelViewIT || !cgPosition
		 || !cgNormal	|| !cgTexcoords || !cgEyePosition ) {
	...
	cgFragmentProgram = cgCreateProgramFromFile( cgContext,
											CG_SOURCE,
											"oglu_per_pixel_reflective_environment_mapping_ps.cg",
											cgFragmentProfile,
											NULL,
											NULL );
    ...
    if ( !cgEnvironmentMap || !cgModelViewI ) {
