//-----------------------------------------------------------------------------
//           Name: dx8_texture_subloading.cpp
//         Author: Kevin Harris
					...
					int       nCmdShow )
{
	...
	g_hWnd = CreateWindowEx( NULL, "MY_WINDOWS_CLASS", 
                             "Direct3D (DX8) - Texture Subloading",
...
void loadTexture( void )
{
	D3DXCreateTextureFromFile( g_pd3dDevice, "tex128.bmp", &g_pTexture );
...
void loadSubTexture( void )
{
	LPDIRECT3DTEXTURE8 pSubTexture = NULL;
	...
	RECT  rcSource[] = { 0, 0, 64, 64 };
	POINT ptDest[]   = { 32, 32 };

	g_pd3dDevice->CopyRects( pSrcSurface, rcSource, 1, pDestSurface, ptDest );
