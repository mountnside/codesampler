//-----------------------------------------------------------------------------
//           Name: ogl_texture_subloading.cpp
//         Author: Kevin Harris
...
void loadTexture( void )	
{
	AUX_RGBImageRec *pTextureImage = auxDIBImageLoad( ".\\tex128.bmp" );
...
void loadSubTexture( void )
{
	AUX_RGBImageRec *pTextureImage = auxDIBImageLoad( ".\\tex64.bmp" );
