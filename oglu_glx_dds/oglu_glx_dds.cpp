...
void init( void )
{
	...
	//This loads the CompressedTexImage2DARB extension.
	glCompressedTexImage2DARB = (PFNGLCOMPRESSEDTEXIMAGE2DARBPROC)glXGetProcAddressARB((const GLubyte*)"glCompressedTexImage2DARB");
	
	g_DDSTexture.Create("./lena.dds");
}
...
void render( void )
{
    ...
    glBindTexture( GL_TEXTURE_2D, g_DDSTexture.m_uiId );
