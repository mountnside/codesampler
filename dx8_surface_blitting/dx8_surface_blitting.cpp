//-----------------------------------------------------------------------------
//           Name: dx8_surface_blitting.cpp
//         Author: Kevin Harris
//  Last Modified: 03/03/04
//    Description: Demonstrates how to animate a sprite by blitting fro a 
//                 DirectDraw surface portions of a bitmap that is being 
//                 stored in a off-screen surface to the back buffer for 
//                 flipping.
//
					...
					int       nCmdShow )
{
	...
	hWnd = CreateWindowEx( NULL, "MY_WINDOWS_CLASS",
						   "DirectDraw (DX8) - 2D Animation Through Surface Blitting",
                           WS_POPUP | WS_VISIBLE,
...
HRESULT render( void )
{
    ...
    // Clear the back buffer to a light gray color using the blitter.
    ddbltfx.dwSize = sizeof( ddbltfx );
    ddbltfx.dwFillColor = 0x1;
