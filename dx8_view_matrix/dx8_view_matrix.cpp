//-----------------------------------------------------------------------------
//           Name: dx8_view_matrix.cpp
//         Author: Kevin Harris
//  Last Modified: 03/03/04
//    Description: This sample demonstrates how to build a custom view matrix
//                 when using Direct3D.
//
					...
					int       nCmdShow )
{
	...
	g_hWnd = CreateWindowEx( NULL, "MY_WINDOWS_CLASS", "Direct3D View Matrix",
...
void init( void )
{
    ...
    g_pVertexBuffer->Lock( 0, sizeof(g_lineVertices), (BYTE**)&pVertices, 0 );
