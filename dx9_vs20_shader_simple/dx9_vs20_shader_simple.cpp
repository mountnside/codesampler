//-----------------------------------------------------------------------------
//           Name: dx9_vs20_shader_simple.cpp
//         Author: Kevin Harris (kevin@codesampler.com)
//  Last Modified: 02/01/05
//    Description: This sample demonstrates how to write a vertex shader or 
//                 vertex program using the Version 2.0 shader implementation 
//                 for Direct3D.
//-----------------------------------------------------------------------------
					...
					int       nCmdShow )
{
	...
	g_hWnd = CreateWindowEx( NULL, "MY_WINDOWS_CLASS", 
                             "Direct3D (DX9) - Simple vs.2.0 Vertex Shader",
...
void initShader( void )
{
	...
	D3DXAssembleShaderFromFile( "dx9_vs20_shader_simple.vsh", NULL, NULL, NULL, &pCode, NULL );
...
void setShaderConstants( void )
{
    ...
    g_pd3dDevice->SetVertexShaderConstantF( 0, (float*)modelViewProjection, 4 );
