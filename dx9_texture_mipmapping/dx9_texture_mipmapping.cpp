//-----------------------------------------------------------------------------
//           Name: dx9_texture_mipmapping.cpp
//         Author: Kevin Harris
					...
					int       nCmdShow )
{
	...
	g_hWnd = CreateWindowEx( NULL, "MY_WINDOWS_CLASS", 
                             "Direct3D (DX9) - Texture Mipmapping",
...
void loadMipMapTexture( void )
{
	...
	// Load our 6 custom made mip-map textures
	...
	// This texture will act as our application's actual mip-map texture as 
	// soon as we copy over 6 of its mip-map levels with our rainbow colored 
	// textures.
