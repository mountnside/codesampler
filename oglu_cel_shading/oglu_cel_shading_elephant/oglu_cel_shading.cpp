...
//
//                 The notorious elephant is used to demonstrate the simple 
...
//
//   Control Keys: Left Mouse Button - Spin the Elephant.
...
{
   HWND hwnd = NULL;
   if ((hwnd = BuildWindow("OpenGL32 Cel-Shaded Model Using a vertex program.", hInstance, 640, 480)) != NULL)
   {
      HDC   hdc = GetDC(hwnd);
...
/* Load in our elephant model. */
   my_model.Load("elephant.sgl");
   my_model.Unitize();
   my_model.Scale(6.0f);
...
//------------------------------------------------------------------------------
// Renders the scene of our elephant.
//------------------------------------------------------------------------------
void IllustrateScene()
{
