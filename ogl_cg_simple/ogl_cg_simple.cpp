...
void render( void )
{
    ...
    // Load a constant color of solid green
    float fConstColor[] = { 0.0f, 1.0f, 0.0f, 1.0f };
    cgGLSetParameter4fv( g_CGparam_constColor, fConstColor );

    cgGLBindProgram( g_CGprogram );
	cgGLEnableProfile( g_CGprofile );

    glInterleavedArrays( GL_C3F_V3F, 0, g_quadVertices );
