...
vector3f g_vEye(-8.5f, 1.8f, 11.1f);  // Eye Position
vector3f g_vLook(0.6f, 0.0f, -0.75f); // Look Vector
...
void initPhysics( void )
{
	...
	for( int i = 0; i < NUM_RED_CUBES; ++i )
	{
		...
		// Uncomment this line to stack the cubes using their size instead of 
...
void render( void )
{
    ...
    //
    // Render the large blue platform, which will keep the cubes from falling...
    //
